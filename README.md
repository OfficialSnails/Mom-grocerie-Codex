...
- Les produits récupérés par OCR ne doivent jamais hériter automatiquement d'une image voisine ou d'une tuile structurée qui montre un autre produit. Avant d'afficher une preuve photo, l'image ou le recadrage doit contenir les mots clés du produit récupéré et le contexte de prix/rabais. Si aucune preuve sûre n'existe, afficher le produit sans preuve plutôt qu'une mauvaise photo.
- Cas St-Méthode: si le pain est visible seulement dans une page de circulaire plus large alors que la tuile structurée montre des céréales, créer ou utiliser un recadrage source-backed de la zone du pain. Ne pas associer la photo des céréales au pain.
- Amélioration OCR attendue pour les futures semaines: faire d'abord la collecte structurée Flipp/Wishabi, ensuite une passe OCR sur les images/pages de circulaire, récupérer les offres manquées très spécifiques, puis valider ou recadrer la preuve avant d'écrire les rapports et le JSON du site.
...
- La classification doit privilégier l'usage réel de l'épicerie: céleri, kiwi, raisins, clémentines, pitaya, poires, dattes, romaine, ail, ananas et avocat vont dans `Fruits et légumes`; goberge/crabe/pollock/surimi, creton, beefsteak, brochettes, côtelettes, veau, surlonge, poisson pané et viandes froides vont dans `Viandes et poissons`; pizza, gaufres Eggo, desserts glacés et repas congelés vont dans `Surgelés`; pilules, médicaments, vitamines, écrans solaires, soins dentaires, cosmétiques et substituts de repas de pharmacie vont dans `Santé et pharmacie`; lessive, assouplissant, savon à vaisselle, papiers et couches vont dans `Maison et entretien`; bologne/bologna, pepperoni, chorizo, rosette, sauciflard, salami, mortadelle et prosciutto vont dans `Viandes et poissons`, même si la source les classe vaguement en épicerie.
