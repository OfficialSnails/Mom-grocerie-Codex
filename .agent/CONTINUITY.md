...
Now: Week `Semaine du 25 juin au 1 juillet 2026` is generated and deployed.
...
- `website/data/weeks/semaine-du-25-juin-au-1-juillet-2026/week.json`
- `reports/weeks/Semaine du 25 juin au 1 juillet 2026/`
...
- `npm run qa:pantry`: passed, no high-confidence suspicious pantry items.
- `npm run qa:categories`: passed, 0 high-confidence errors, 8 ambiguous review items, report at `reports/qa/category-review-semaine-du-25-juin-au-1-juillet-2026.md`.
- Live verification: `https://bons-speciaux-joliette.pages.dev/data/weeks/index.json` returned latest week `25 juin au 1 juillet 2026`.
